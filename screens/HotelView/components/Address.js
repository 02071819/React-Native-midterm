    ...
    return (
        <View>
            <View style={{ backgroundColor: "#000" }}>
                <Image source={require("../../../assets/maps.gif")} style={{ height: 200, opacity: 0.2 }} />
            </View>

            <View style={styles.addressContainer}>
                <View style={{ marginLeft: 8, marginTop: 24 }}>
                    <Text style={gs.sectionTitle}>Address</Text>
                    <Text style={styles.address}>dsbfojvbwoeibfvqoaiwbdqbaowjbvokqjbwodjbvqkjbwkjdbvqojbw</Text>
